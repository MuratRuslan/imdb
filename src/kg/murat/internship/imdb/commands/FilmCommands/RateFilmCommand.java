 ...
 */
public class RateFilmCommand extends AbstractFilmCommand {

    public RateFilmCommand(FilmService filmService, String command, Logger logger) {
        super(filmService, command, logger);
    }
    @Override
    public void execute() {
        try {
            filmService.rateFilm(command);
        } catch (Exception e) {
