 ...
 */
public class ListAllFilmsByCountry extends AbstractFilmCommand {
    public ListAllFilmsByCountry(FilmService filmService, String command, Logger logger) {
    ...
    public void execute() {
        try {
            filmService.listFilmsByCountry(command);
        } catch (Exception e) {
