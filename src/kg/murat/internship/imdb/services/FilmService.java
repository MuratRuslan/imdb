...
public interface FilmService {
    ...
    List<Film> listAllFilmsBefore(String command, Integer year);
    List<Film> listAllFilmsAfter(String command, Integer year);
    Set<Film> listAllSortedFilmsByRateDesc(String command);
}
